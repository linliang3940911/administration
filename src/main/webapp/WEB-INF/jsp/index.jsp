                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-edit"></i>个人考勤<span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu" style="display: none">
                                    ...
                                    <li><a href="javascript:tiaozhuan('请假登记','jumpController/toLeaveRegistration')">请假登记</a>
                                    </li>
                                    <li><a href="javascript:tiaozhuan('发起申请','modle/queryListWorkName')">发起申请</a>
                                    </li>
                                    <li><a href="javascript:tiaozhuan('我的网盘','modle/wangpan')">网盘</a>
                                    </li>
                                    <li><a href="javascript:tiaozhuan('上下班打卡','modle/qiandaorili')">上下班打卡</a>
                                    </li>
                                </ul>
                            </li>
                                ...
                                <ul class="nav child_menu" style="display: none">
                                    <li><a> 流程办理 <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu" style="display: none">
                                            ...
                                            <li><a href="javascript:tiaozhuan('每月的流程','caoxin/bohuilist')">每月的流程</a></li>
                                        </ul>
                                    </li>
            ...
            <nav class="" role="navigation">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li role="presentation" class="dropdown">
                        <a href="javascript:queryzx();" class="dropdown-toggle info-number" data-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul id="menu1" class="dropdown-menu list-unstyled msg_list animated fadeInDown" role="menu">
                            <c:forEach items="${list}" var="zx">
                                <li>
                                        ${loginUser.username}&nbsp;<img width="10px" hidden="10px" src=${loginUser.userimg}/>
                                        ${zx.woname}
                                </li>
                            </c:forEach>
                        </ul>
                    ...
                    <div role="tabpanel"class="tab-pane active"id="home">
                        ...
                        <div class="">
                            <div class="row top_tiles"  >
                                <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12" onclick="tiaozhuan('紧急流程','caoxin/jinji')" >
                                ...
                                <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12" onclick="tiaozhuan('重要流程','caoxin/zhongyao')">
                                    <div class="tile-stats">
                                ...
                                <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12" onclick="tiaozhuan('普通流程','caoxin/putong')">
                                    <div class="tile-stats">
                                ...
                                <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12" onclick="tiaozhuan('其他代办流程','caoxin/qita')">
                                    <div class="tile-stats"  >
