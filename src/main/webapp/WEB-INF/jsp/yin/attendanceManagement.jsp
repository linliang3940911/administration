...
<frameset cols="10%,80%" rows="*" FRAMEspacing=0 border=0>
        <frame src="<%=request.getContextPath()%>/jumpController/toMyAttendanceManagementLeft" name="left"/>
        <frame src="<%=request.getContextPath()%>/jumpController/toMySchedule" name="rights"/>
</frameset>
