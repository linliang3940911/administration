...
public class OSSClientUtil {
	 public static final Logger logger = LoggerFactory.getLogger(OSSClientUtil.class);  
	    ...
	    // accessKey  
	    private String accessKeyId = "LTAIC2BQzudPKRPc";
	    private String accessKeySecret = "v6r0cNAV5OSHgn6HQJ5JWzFDY1ECo4";
	    // 空间  
	    private String bucketName = "cx-0-oss";
	    // 文件存储目录  
	    private String filedir = "cx-img/";
